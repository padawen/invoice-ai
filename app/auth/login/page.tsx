  ...
  return (
    <main className="select-none flex items-center justify-center min-h-screen bg-gradient-to-br from-zinc-900 via-black to-zinc-800 text-white relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-[40%] left-[5%] w-[250px] h-[250px] bg-green-500/12 rounded-full blur-3xl" />
        <div className="absolute top-[60%] left-[10%] w-[280px] h-[280px] bg-emerald-400/10 rounded-full blur-3xl" />
        <div className="absolute bottom-[10%] left-[8%] w-[220px] h-[220px] bg-green-400/11 rounded-full blur-3xl" />

        <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-blue-500/10 rounded-full blur-2xl" />
        <div className="absolute bottom-[10%] right-[10%] w-[250px] h-[250px] bg-blue-400/12 rounded-full blur-3xl" />
        <div className="absolute bottom-[20%] right-[15%] w-[180px] h-[180px] bg-cyan-500/10 rounded-full blur-3xl" />
        <div className="absolute top-[10%] right-[5%] w-[300px] h-[300px] bg-blue-500/11 rounded-full blur-3xl" />
        <div className="absolute top-[35%] right-[8%] w-[240px] h-[240px] bg-cyan-400/10 rounded-full blur-3xl" />
        <div className="absolute top-[55%] right-[12%] w-[200px] h-[200px] bg-blue-400/11 rounded-full blur-3xl" />
      </div>
